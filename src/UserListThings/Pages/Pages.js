                ...
                <Col>
                    <NavLink to="/alist">
                        <span className='click-icon book' onClick={() => handleButtonClick(setBookActive)}>
                            <img src={bookActive ? '/UserListSource/book-a.png' : '/UserListSource/book.png'} style={{ width: "48px", height: '48px', paddingBottom: '0' }} alt='A book icon' />
                        </span>
                ...
                <Col>
                    <NavLink to="/alist">
                        <span className='click-icon hiking' onClick={() => handleButtonClick(setHikingActive)}>
                            <img src={hikingActive ? '/UserListSource/hiking-a.png' : '/UserListSource/hiking.png'} style={{ width: "48px", height: '48px', paddingBottom: '0' }} alt='A hiker icon' />
                        </span>
                ...
                <Col>
                    <NavLink to="/alist">
                        <span className='click-icon ship' onClick={() => handleButtonClick(setShipActive)}>
                            <img src={shipActive ? '/UserListSource/ship-a.png' : '/UserListSource/ship.png'} style={{ width: "48px", height: '48px', paddingBottom: '0' }} alt='A ship icon' />
                        </span>
